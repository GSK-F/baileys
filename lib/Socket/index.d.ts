...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
  ...
  fetchMessageHistory: (
    count: number,
    oldestMsgKey: import('../Types').WAMessageKey,
  ...
  sendReceipts: (
    keys: import('../Types').WAMessageKey[],
    type: import('../Types').MessageReceiptType
  ) => Promise<void>;
  ...
  createParticipantNodes: (
    jids: string[],
    message: import('../Types').WAProto.IMessage,
    extraAttrs?: import('..').BinaryNode['attrs']
  ) => Promise<{
  ...
  newsletterMetadata: (
    type: 'invite' | 'jid',
    key: string,
    role?: import('../Types').NewsletterViewRole
  ) => Promise<import('../Types').NewsletterMetadata>;
  ...
  waitForConnectionUpdate: (
    check: (u: Partial<import('../Types').ConnectionState>) => Promise<boolean | undefined>,
    timeoutMs?: number
  ) => Promise<void>;
