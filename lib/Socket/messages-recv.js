...
const makeMessagesRecvSocket = config => {
  ...
  const handleGroupNotification = (participant, child, msg) => {
    ...
    const participantJid =
      ((_b =
        (_a = (0, WABinary_1.getBinaryNodeChild)(child, 'participant')) === null || _a === void 0
          ? void 0
    ...
    switch (child === null || child === void 0 ? void 0 : child.tag) {
      ...
      case 'leave':
        ...
        const participants = (0, WABinary_1.getBinaryNodeChildren)(child, 'participant').map(
          p => p.attrs.jid
        );
        if (
      ...
      case 'description':
        const description =
          (_d =
            (_c = (0, WABinary_1.getBinaryNodeChild)(child, 'body')) === null || _c === void 0
              ? void 0
  ...
  const handleMexNewsletterNotification = (id, node) => {
    ...
    const content = JSON.parse(
      (_a = node === null || node === void 0 ? void 0 : node.content) === null || _a === void 0
        ? void 0
        : _a.toString()
    );
    let contentPath;
      ...
      case 'picture':
        ...
        ev.emit('contacts.update', [
          {
            id:
              from ||
              ((_b =
                (_a = setPicture || delPicture) === null || _a === void 0 ? void 0 : _a.attrs) ===
                null || _b === void 0
                ? void 0
                : _b.hash) ||
              '',
        ...
        if ((0, WABinary_1.isJidGroup)(from)) {
          ...
          result.key = {
            ...(result.key || {}),
            participant:
              setPicture === null || setPicture === void 0 ? void 0 : setPicture.attrs.author,
          };
        }
        break;
      case 'account_sync':
  ...
  const handleMessage = async node => {
    ...
    if (
      ((_c = (_b = msg.message) === null || _b === void 0 ? void 0 : _b.protocolMessage) === null ||
      _c === void 0
        ? void 0
      ...
      await Promise.all([
        processingMutex.mutex(async () => {
          ...
          if (msg.messageStubType === WAProto_1.proto.WebMessageInfo.StubType.CIPHERTEXT) {
            if (
              ((_a = msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) ===
                null || _a === void 0
                ? void 0
            ...
            let type = undefined;
            if (
              (_b = msg.key.participant) === null || _b === void 0 ? void 0 : _b.endsWith('@lid')
            ) {
            ...
            if (
              ...
              if (msg.message.extendedTextMessage.contextInfo) {
                ...
                msg.message.extendedTextMessage.contextInfo.participant =
                  (found === null || found === void 0 ? void 0 : found.jid) || sender;
              }
            }
            if (
              !(0, WABinary_1.isJidGroup)(msg.key.remoteJid) &&
