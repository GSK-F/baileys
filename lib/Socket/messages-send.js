...
const makeMessagesSocket = config => {
  ...
  const getUSyncDevices = async (jids, useCache, ignoreZeroDevices) => {
    ...
    for (let jid of jids) {
      const user =
        (_a = (0, WABinary_1.jidDecode)(jid)) === null || _a === void 0 ? void 0 : _a.user;
  ...
  const relayMessage = async (
    ...
    msgId =
      msgId ||
      (0, Utils_1.generateMessageIDV2)((_a = sock.user) === null || _a === void 0 ? void 0 : _a.id);
    ...
    await authState.keys.transaction(async () => {
      ...
      if (
        (_a = (0, Utils_1.normalizeMessageContent)(message)) === null || _a === void 0
          ? void 0
          : _a.pinInChatMessage
      ) {
      ...
      if (isGroup || isStatus) {
        const [groupData, senderKeyMap] = await Promise.all([
          (async () => {
            ...
            if (
              groupData &&
              Array.isArray(
                groupData === null || groupData === void 0 ? void 0 : groupData.participants
              )
            ) {
              logger.trace(
        ...
        if (!participant) {
          ...
          if (!isStatus) {
            additionalAttributes = {
              ...
              // eslint-disable-next-line camelcase
              addressing_mode:
                (groupData === null || groupData === void 0 ? void 0 : groupData.addressingMode) ||
                'pn',
            };
          }
        ...
        // Message delete
        if (
          ((_d = message.protocolMessage) === null || _d === void 0 ? void 0 : _d.type) ===
        ...
        for (const { user, device } of devices) {
          ...
          const jid = (0, WABinary_1.jidEncode)(
            isMe && isLid
              ? ((_g = (_f = authState.creds) === null || _f === void 0 ? void 0 : _f.me) ===
                  null || _g === void 0
                  ? void 0
                  : _g.lid.split(':')[0]) || user
              : user,
      ...
      if (participants.length) {
        if (
          ...
          const peerNode =
            (_j = (_h = participants[0]) === null || _h === void 0 ? void 0 : _h.content) ===
              null || _j === void 0
              ? void 0
              : _j[0];
          if (peerNode) {
      ...
      if (
        ...
        if (
          ((_l =
            (_k = message === null || message === void 0 ? void 0 : message.viewOnceMessage) ===
              null || _k === void 0
              ? void 0
          ...
          ((_o =
            (_m = message === null || message === void 0 ? void 0 : message.viewOnceMessageV2) ===
              null || _m === void 0
              ? void 0
          ...
          ((_s =
            (_r = message === null || message === void 0 ? void 0 : message.viewOnceMessage) ===
              null || _r === void 0
              ? void 0
            ...
            : _s.buttonsMessage) ||
          ((_u =
            (_t = message === null || message === void 0 ? void 0 : message.viewOnceMessageV2) ===
              null || _t === void 0
              ? void 0
    ...
    sendMessage: async (jid, content, options = {}) => {
      ...
      if (!options.ephemeralExpiration) {
        if ((0, WABinary_1.isJidGroup)(jid)) {
          ...
          const expiration =
            ((_b =
              (_a = (0, WABinary_1.getBinaryNodeChild)(metadata, 'ephemeral')) === null ||
              _a === void 0
                ? void 0
      ...
      if (typeof content === 'object' && 'album' in content && content.album) {
        ...
        if (isDeleteMsg) {
          ...
          if (
            ((0, WABinary_1.isJidGroup)(content.delete.remoteJid) && !content.delete.fromMe) ||
