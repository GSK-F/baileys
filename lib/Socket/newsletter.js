...
const makeNewsletterSocket = config => {
    ...
    return await Promise.all(
      (0, WABinary_1.getAllBinaryNodeChildren)(child).map(async messageNode => {
        ...
        const views = parseInt(
          ((_b =
            (_a = (0, WABinary_1.getBinaryNodeChild)(messageNode, 'views_count')) === null ||
            _a === void 0
              ? void 0
        ...
        const reactions = (0, WABinary_1.getBinaryNodeChildren)(reactionNode, 'reaction').map(
  ...
  return {
    ...
    newsletterAdminCount: async jid => {
      ...
      const buff =
        (_b =
          (_a = (0, WABinary_1.getBinaryNodeChild)(result, 'result')) === null || _a === void 0
            ? void 0
...
const extractNewsletterMetadata = (node, isCreate) => {
  ...
  const result =
    (_b =
      (_a = (0, WABinary_1.getBinaryNodeChild)(node, 'result')) === null || _a === void 0
        ? void 0
        : _a.content) === null || _b === void 0
      ? void 0
      : _b.toString();
  ...
  const metadata = {
    ...
    picture:
      ((_c = metadataPath.thread_metadata.picture) === null || _c === void 0
        ? void 0
        : _c.direct_path) || null,
    preview:
      ((_d = metadataPath.thread_metadata.preview) === null || _d === void 0
        ? void 0
        : _d.direct_path) || null,
