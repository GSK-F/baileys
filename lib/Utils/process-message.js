...
const processMessage = async (
  ...
  const mJids =
    content && content.contextInfo && content.contextInfo.mentionedJid
  ...
  if (
    ...
    (0, WABinary_1.isLidUser)(content.contextInfo.participant)
  ) {
  ...
  if (
    (isRealMsg ||
      ((_b =
        (_a = content === null || content === void 0 ? void 0 : content.reactionMessage) === null ||
        _a === void 0
          ? void 0
  ...
  if (protocolMsg) {
      ...
      case WAProto_1.proto.Message.ProtocolMessage.Type.HISTORY_SYNC_NOTIFICATION:
        ...
        if (process) {
          ...
          ev.emit('messaging-history.set', {
            ...data,
            isLatest:
              histNotification.syncType !== WAProto_1.proto.HistorySync.HistorySyncType.ON_DEMAND
                ? isLatest
                : undefined,
    ...
    switch (message.messageStubType) {
      ...
      case Types_1.WAMessageStubType.GROUP_CHANGE_DESCRIPTION:
        const description =
          (_k = message.messageStubParameters) === null || _k === void 0 ? void 0 : _k[0];
        chat.description = description;
        emitGroupUpdate({ desc: description });
        break;
      case Types_1.WAMessageStubType.GROUP_CHANGE_INVITE_LINK:
        const code =
          (_l = message.messageStubParameters) === null || _l === void 0 ? void 0 : _l[0];
        emitGroupUpdate({ inviteCode: code });
        break;
      case Types_1.WAMessageStubType.GROUP_MEMBER_ADD_MODE:
        const memberAddValue =
          (_m = message.messageStubParameters) === null || _m === void 0 ? void 0 : _m[0];
        emitGroupUpdate({ memberAddMode: memberAddValue === 'all_member_add' });
        break;
      case Types_1.WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_MODE:
        const approvalMode =
          (_o = message.messageStubParameters) === null || _o === void 0 ? void 0 : _o[0];
        emitGroupUpdate({ joinApprovalMode: approvalMode === 'on' });
        break;
      case Types_1.WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_REQUEST_NON_ADMIN_ADD:
        const participant =
          (_p = message.messageStubParameters) === null || _p === void 0 ? void 0 : _p[0];
        const action =
          (_q = message.messageStubParameters) === null || _q === void 0 ? void 0 : _q[1];
        const method =
          (_r = message.messageStubParameters) === null || _r === void 0 ? void 0 : _r[2];
    ...
    if (pollMsg) {
      ...
      const pollEncKey =
        (_s = pollMsg.messageContextInfo) === null || _s === void 0 ? void 0 : _s.messageSecret;
      try {
