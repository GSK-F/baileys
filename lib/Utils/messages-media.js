  ...
  const services = [
    ...
    },
    {
      ...
      parseResponse: res => {
        ...
        if (
          !((_c =
            (_b = (_a = res.data) === null || _a === void 0 ? void 0 : _a.files) === null ||
            _b === void 0
              ? void 0
              : _b[0]) === null || _c === void 0
            ? void 0
...
async function generateThumbnail(file, mediaType, options) {
  ...
  if (mediaType === 'image') {
    ...
    try {
      ...
      const { buffer: processedThumbnailBuffer, original } = await (0, exports.extractImageThumb)(
        imgFilename
      );
...
const downloadContentFromMessage = async ({ mediaKey, directPath, url }, type, opts = {}) => {
  const isValidMediaUrl =
    url === null || url === void 0 ? void 0 : url.startsWith('https://mmg.whatsapp.net/');
