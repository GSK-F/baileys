...
const generateForwardMessageContent = (message, forceForward) => {
  ...
  let score =
    ((_a = content[key].contextInfo) === null || _a === void 0 ? void 0 : _a.forwardingScore) || 0;
...
const generateWAMessageContent = async (message, options) => {
  ...
  if ('text' in message) {
    ...
    const sticker = (
      (_c = message === null || message === void 0 ? void 0 : message.requestPayment) === null ||
      _c === void 0
        ? void 0
        : _c.sticker
    )
      ? await (0, exports.prepareWAMessageMedia)(
          {
            sticker:
              (_d = message === null || message === void 0 ? void 0 : message.requestPayment) ===
                null || _d === void 0
                ? void 0
                : _d.sticker,
            ...options,
    ...
    let notes = {};
    if (
      (_e = message === null || message === void 0 ? void 0 : message.requestPayment) === null ||
      _e === void 0
        ? void 0
        : _e.sticker
    ) {
      notes = {
        stickerMessage: {
          ...
          contextInfo:
            (_f = message === null || message === void 0 ? void 0 : message.requestPayment) ===
              null || _f === void 0
              ? void 0
              : _f.contextInfo,
        },
      ...
      notes = {
        extendedTextMessage: {
          ...
          contextInfo:
            (_g = message === null || message === void 0 ? void 0 : message.requestPayment) ===
              null || _g === void 0
              ? void 0
              : _g.contextInfo,
        },
  ...
  if ('interactiveButtons' in message && !!message.interactiveButtons) {
    ...
    if ('text' in message) {
      ...
      interactiveMessage.header = {
        ...
        hasMediaAttachment:
          (_j = message === null || message === void 0 ? void 0 : message.media) !== null &&
          _j !== void 0
            ? _j
            : false,
      };
    ...
    if ('title' in message && !!message.title) {
      interactiveMessage.header = {
        ...
        subtitle: message.subtitle,
        hasMediaAttachment:
          (_k = message === null || message === void 0 ? void 0 : message.media) !== null &&
          _k !== void 0
            ? _k
            : false,
      };
  ...
  if ('shop' in message && !!message.shop) {
    ...
    if ('text' in message) {
      ...
      interactiveMessage.header = {
        ...
        subtitle: message.subtitle,
        hasMediaAttachment:
          (_l = message === null || message === void 0 ? void 0 : message.media) !== null &&
          _l !== void 0
            ? _l
            : false,
      };
    ...
    if ('title' in message && !!message.title) {
      interactiveMessage.header = {
        ...
        subtitle: message.subtitle,
        hasMediaAttachment:
          (_m = message === null || message === void 0 ? void 0 : message.media) !== null &&
          _m !== void 0
            ? _m
            : false,
      };
...
const extractMessageContent = content => {
  ...
  if (
    ...
    return extractFromTemplateMessage(
      (_b = content === null || content === void 0 ? void 0 : content.templateMessage) === null ||
        _b === void 0
        ? void 0
  ...
  if (
    ...
    return extractFromTemplateMessage(
      (_d = content === null || content === void 0 ? void 0 : content.templateMessage) === null ||
        _d === void 0
        ? void 0
        : _d.hydratedTemplate
    );
  ...
  if (
    ...
    return extractFromTemplateMessage(
      (_f = content === null || content === void 0 ? void 0 : content.templateMessage) === null ||
        _f === void 0
        ? void 0
        : _f.fourRowTemplate
    );
...
const updateMessageWithPollUpdate = (msg, update) => {
  ...
  if (
    (_b = (_a = update.vote) === null || _a === void 0 ? void 0 : _a.selectedOptions) === null ||
    _b === void 0
      ? void 0
      : _b.length
  ) {
...
const downloadMediaMessage = async (message, type, options, ctx) => {
  ...
  async function downloadMsg() {
    ...
    let mediaType =
      contentType === null || contentType === void 0 ? void 0 : contentType.replace('Message', '');
